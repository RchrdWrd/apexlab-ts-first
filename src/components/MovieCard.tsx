  ...
  render() {
    return (
      <Box
        ...
        sx={{background: `url(${this.props.movieImgPoster})`, backgroundPosition: 'center', backgroundRepeat: 'no-repeat', backgroundSize: 'cover'}} 
       >
        <Box
          width="250px"
          borderRadius="15px"
          sx={{background: 'linear-gradient(180deg, rgba(0,0,0,0.7) 70%, rgba(85,94,174, 0.9) 100%)'}}>
          <Box
            minHeight="150px"
            color="#2de1af"
          >
