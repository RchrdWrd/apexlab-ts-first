      ...
      >
        ...
        >
          <Box
            ...
            sx={{
              background:
                "linear-gradient(180deg, rgba(0,0,0,0.8) 70%, rgba(85,94,174, 0.9) 100%)",
          ...
          >
            <ScrollIntoView selector="#movieList">
              <Button
                variant="contained"
                sx={{ backgroundColor: "#2de1af", color: "rgb(30,30,30)" }}
              >
                Back to the search
              </Button>
            </ScrollIntoView>
            <Box color="#2de1af" p={4} paddingBottom={1}>
              <Typography
                gutterBottom
                variant="h4"
                component="div"
            ...
            >
              <Typography variant="body2" color="#2de1af">
                ...
                <Box
                  ...
                  sx={{
                    background:
                      "linear-gradient(90deg, rgba(45,225,175,0.0) 0%, rgba(45,225,175,0.7) 15%, rgba(45,225,175,0.7) 85%, rgba(45,225,175,0.0) 100%)",
                  }}
                />
                <Rating
                  name="read-only"
